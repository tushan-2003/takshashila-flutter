...
class PaymentDesk extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  const ListTile(
                    ...
                    trailing: Text("Rs.1000", style: TextStyle(fontSize: 18)),
                  ),
                  const Divider(
                    thickness: 2,
                    color: Colors.black,
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (card == null ||
                                    ...
                                    card!.cvc.isEmpty) {
                                  snackBar(context, "Fill the payment Details");
                                } else {
